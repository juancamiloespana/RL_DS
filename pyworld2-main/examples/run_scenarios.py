...
w2_sc2.set_switch_functions("./examples/scenarios/functions_switch_scenario_2.json")
w2_sc2.run()
...
w2_sc3.set_switch_functions("./examples/scenarios/functions_switch_scenario_3.json")
w2_sc3.run()
...
w2_sc4.set_table_functions("./examples/scenarios/functions_table_scenario_4.json")
w2_sc4.set_switch_functions("./examples/scenarios/functions_switch_scenario_4.json")
w2_sc4.run()
...
w2_sc5.set_switch_functions("./examples/scenarios/functions_switch_scenario_5.json")
w2_sc5.run()
...
w2_sc6.set_switch_functions("./examples/scenarios/functions_switch_scenario_6.1.json")
w2_sc6.run()
...
w2_sc62.set_switch_functions("./examples/scenarios/functions_switch_scenario_6.2.json")
w2_sc62.run()
...
w2_sc63.set_switch_functions("./examples/scenarios/functions_switch_scenario_6.3.json")
w2_sc63.run()
...
w2_sc64.set_switch_functions("./examples/scenarios/functions_switch_scenario_6.4.json")
w2_sc64.run()
...
w2_sc7.set_switch_functions("./examples/scenarios/functions_switch_scenario_7.json")
w2_sc7.run()
...
w2_sc81.set_switch_functions("./examples/scenarios/functions_switch_scenario_8.1.json")
w2_sc81.run()
...
w2_sc82.set_switch_functions("./examples/scenarios/functions_switch_scenario_8.2.json")
w2_sc82.run()
...
w2_sc83.set_switch_functions("./examples/scenarios/functions_switch_scenario_8.3.json")
w2_sc83.run()
...
w2_sc9.set_switch_functions("./examples/scenarios/functions_switch_scenario_9.json")
w2_sc9.run()
...
w2_sc10.set_switch_functions("./examples/scenarios/functions_switch_scenario_10.json")
w2_sc10.run()
