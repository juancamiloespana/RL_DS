...
#P=np.array([np.random.uniform(low, high) for low, high in Lim])
...
data_acum.to_csv('datos_egreedy_lotka_volterra_arranques aleatorios.csv', index=False)

data_acum_1=data_acum
