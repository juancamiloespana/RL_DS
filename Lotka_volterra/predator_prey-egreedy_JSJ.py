...
#P = [0.00242, 0.03012, 0.14904, 0.00200] 
...
R_inicial, *_ = lotka_volterra_instance.simulate() # Solución inicial del modelo de dinámica de sistemas
...
for i in tqdm(range(Runs)):
    ...
    R_previo,*_ = lotka_volterra_instance.simulate()
    ...
    if Cumple_Limites(P,Lim) == True:
        ...
        lotka_volterra_instance = LotkaVolterraModel(*P)
        R_actual, *_ = lotka_volterra_instance.simulate()
